...
INSERT INTO asf_apis (permission_id, name,type,path,http_methods,is_system,description,is_logger) VALUES (16, '添加富文本内容',1,'/api/asf/editor/add','post',1,'添加富文本内容',0);
