...
namespace ASF.Domain
{
    ...
    public class ResultCodes : BaseResultCodes
    {
        ...
        public static ValueTuple<int, string> AccountPermissionEmpty = (11001, "账户为空");
        public static ValueTuple<int, string> AccountUsernameExist = (11002, "输入的用户名已经被使用，请重新输入");
        public static ValueTuple<int, string> AccountOldPasswordAndNewPasswordSame = (11003, "新密码和旧密码不能一样，为了安全请重新输入");
        public static ValueTuple<int, string> AccountTelephoneExist = (11004, "输入的手机号码已经被使用，请重新输入");
        public static ValueTuple<int, string> AccountNotExist = (11005, "用户不存在");
        public static ValueTuple<int, string> AccountEmailExist = (11006, "输入的邮箱地址已经被使用，请重新输入");
        public static ValueTuple<int, string> AccountRoleAssignationFailed = (11007, "账户角色分配失败，请重试");
        public static ValueTuple<int, string> AccountNotAllowedLogin = (11008, "账户被禁止登陆，请联系管理员");
        public static ValueTuple<int, string> AccountUnavailable = (11009, "账户暂不可以使用");
        public static ValueTuple<int, string> AccountPasswordNotSame = (11010, "账户密码不匹配");
        public static ValueTuple<int, string> AccountPasswordNotSame2 = (11011, "账户密码不匹配，失败{0}次之后自动锁定账号");
        public static ValueTuple<int, string> AccountPasswordNotSameOverrun = (11012, "登录失败超限，请30分钟之后再试");
